...
from Products.spiders.Shopclues import ShopcluesSpider

f = open('Input_Shopclues.csv', 'r')
...
try:
    ...
    process.crawl(ShopcluesSpider, product_names=p_names, low_prices=low_prs, high_prices=high_prs, brand_names=brands, conditions=p_cons, product_filters=p_fltrs)
    process.start()

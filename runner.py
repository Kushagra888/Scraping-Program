...
from Products.spiders.Rediff import RediffSpider

f = open('Input_Rediff.csv', 'r')
...
try:
    ...
    process.crawl(RediffSpider, product_names=p_names, low_prices=low_prs, high_prices=high_prs, brand_names=brands, conditions=p_cons, product_filters=p_fltrs)
    process.start()

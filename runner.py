...
from Products.spiders.Bitfang import BitfangSpider

f = open('Input_Bitfang.csv', 'r')
...
try:
    ...
    process.crawl(BitfangSpider, product_names=p_names, low_prices=low_prs, high_prices=high_prs, brand_names=brands, conditions=p_cons, product_filters=p_fltrs)
    process.start()

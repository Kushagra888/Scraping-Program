...
from Products.spiders.Paytmmall import PaytmmallSpider

f = open('Input_Paytmmall.csv', 'r')
...
try:
    ...
    process.crawl(PaytmmallSpider, product_names=p_names, low_prices=low_prs, high_prices=high_prs, brand_names=brands, conditions=p_cons, product_filters=p_fltrs)
    process.start()
